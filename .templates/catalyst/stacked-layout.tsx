...
function MobileSidebar({
  ...
  return (
    <Headless.Dialog open={open} onClose={close} className="lg:hidden">
      ...
      >
        <div className="shadow-xs flex h-full flex-col rounded-lg bg-white ring-1 ring-zinc-950/5 dark:bg-zinc-900 dark:ring-white/10">
  ...
  return (
    <div className="relative isolate flex min-h-svh w-full flex-col bg-white lg:bg-zinc-100 dark:bg-zinc-900 dark:lg:bg-zinc-950">
      ...
      <main className="flex flex-1 flex-col pb-2 lg:px-2">
        <div className="lg:shadow-xs grow p-6 lg:rounded-lg lg:bg-white lg:p-10 lg:ring-1 lg:ring-zinc-950/5 dark:lg:bg-zinc-900 dark:lg:ring-white/10">
